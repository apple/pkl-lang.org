...
[NOTE]
As of 2024/10/10, The xref:lsp:index.adoc[Pkl Language Server] has been released.
This enables rich editor support for our xref:vscode:index.adoc[VS Code] and xref:neovim:index.adoc[Neovim] plugins.
