...
If you are not certain if something counts as a security vulnerability, you can review our xref:threat-model.adoc#out-of-scope[Out of Scope] section of our threat model.
