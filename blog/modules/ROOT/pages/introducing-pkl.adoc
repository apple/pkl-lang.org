...
typealias Enviornment = "dev"|"qa"|"prod"
----
...
extension Application {
    public enum Enviornment: String, CaseIterable, Decodable, Hashable {
        case dev = "dev"
        case qa = "qa"
        case prod = "prod"
    }
    ...
    public struct Module: PklRegisteredType, Decodable, Hashable {
        ...
        /// The environment to deploy to.
        public var environment: Enviornment

        /// The database connection for this application
        public var database: Database

        public init(hostname: String, port: UInt16, environment: Enviornment, database: Database) {
...
type Application struct {
	...
	// The environment to deploy to.
	Environment enviornment.Enviornment `pkl:"environment"`
...
type Enviornment string

const (
	Dev  Enviornment = "dev"
	Qa   Enviornment = "qa"
	Prod Enviornment = "prod"
)

// String returns the string representation of Enviornment
func (rcv Enviornment) String() string {
	return string(rcv)
}
----
--
...
public final class Application {
   ...
   * The environment to deploy to.
   */
  public final @NonNull Enviornment environment;
  ...
  public Application(@Named("hostname") @NonNull String hostname, @Named("port") int port,
      @Named("environment") @NonNull Enviornment environment,
  ...
  public enum Enviornment {
    ...
    private Enviornment(String value) {
      this.value = value;
    }
