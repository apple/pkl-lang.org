:uri-github-issue-pkl: https://github.com/apple/pkl-lang.org/issues/new
:uri-seven-rules: https://cbea.ms/git-commit/#seven-rules

= pkl-lang.org Contributors Guide
...
pkl-lang.org is released under the Apache 2.0 license.
